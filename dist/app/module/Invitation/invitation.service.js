...
const sendInvitation = async (eventId, targetUserId, requesterId) => {
...
const acceptInvitation = async (invitationId, targetUserId) => {
...
const declineInvitation = async (invitationId, targetUserId) => {
    const invitation = await prisma.invitation.findUnique({
        where: { id: invitationId },
    });
    if (!invitation)
